...
contains
    ...
    subroutine interp(Model_p,Model_s,x,y,z)
            real,intent(out) :: Model_p(76, 61, 27), Model_s(76, 61, 27), x(76), y(61), z(27)
            integer :: aa
            real :: lon, lat, depth, p_vel, s_vel
            integer :: i, j, k
            ...
            open(1010,file = 'H14.xyzv',status = 'OLD',action = 'read', access = 'sequential')
            do i = 1,76
                do j = 1,61
                    do k = 1,27                        
                        read(1010,*)lon, lat, depth, p_vel, s_vel
                        do while (x(i) == -99999.0)
                            x(i) = lon
                        end do
    ...
    subroutine find_location(Model, x, y, z, lon, lat, dep, V_interp)
            ...
            real, intent(in) :: Model(76,61,27), x(76), y(61), z(27)
